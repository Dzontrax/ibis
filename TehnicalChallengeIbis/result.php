    ...
    <div class="container-fluid" >
        <div class="row">
            <div class="col-xl-12 col-xs-12">
                <form id="forma" name="forma" class="form-inline" style="height: 50px;" >
                        ...
                        <button type="submit" id="reset" class="btn btn-outline-success my-2 my-sm-0 resetFiltersBtn float-xs-left float-right " onclick="window.location='http://localhost:8080/TehnicalChallengeIbis/index.php'"><i class="fas fa-filter"></i><a href="http://localhost:8080/TehnicalChallengeIbis/index.phps"></a>  Reset filters</button>
                </form>
            </div>
        </div>
            ...
            <div class="col-xl-2 col-xs-12">
                    <div class="card results">
                        <div class="card-body">
                            ...
                            <p>MAC: </p> <p><?php echo $_GET["mac"]; ?></p>  <br>
                            <p>Contract: <p><?php echo $_GET["contract"]; ?></p><br />
